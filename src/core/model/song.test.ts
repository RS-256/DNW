...
import { createDefaultSong, createLayer, findNoteIndexAt, insertNoteSorted, lowerBoundByTick, songLength } from "./song"
...
describe( "createDefaultSong", () => {
  ...
  it( "has bpm and time signature events at tick 0", () => {
    ...
    expect( song.tempoTrack.events.some( ( e ) => e.type === "timeSignature" && e.tick === 0 ) ).toBe( true )
  } )
} )
