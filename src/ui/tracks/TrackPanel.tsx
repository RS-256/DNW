...
export default function TrackPanel() {
  ...
  const [ editing, setEditing ] = useState< { kind: "layer" | "group"; id: string; name: string } | null >( null )
  ...
  const renderGroupRow = ( group: TrackGroup ) => (
    ...
    >
      ...
      />
      <button className="track-remove" onClick={ () => deleteGroup( group.id ) } title="Ungroup (tracks are kept)">
        ×
      </button>
    </div>
  )
