...
export default function LitematicSettings( {
  ...
  return (
    <div className="lit-settings">
      ...
      { slots.length === 0 ? (
        <p className="lit-slots-empty">All notes fit vanilla note blocks — no config needed.</p>
      ) : (
        <>
          <div className="lit-slot-table">
            <div className="lit-slot-row lit-slot-header">
              ...
              <span title="Block placed under the note block; written to infinote.json">base block</span>
            </div>
            { slots.map( ( slot ) => {
