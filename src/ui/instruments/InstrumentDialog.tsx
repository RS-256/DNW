...
export default function InstrumentDialog( { onClose }: { onClose: () => void } ) {
  ...
  const customs = instruments.map( ( inst, index ) => ( { inst, index } ) ).filter( ( { inst } ) => ! inst.isVanilla )
    ...
    <div className="dialog-backdrop" onClick={ onClose }>
      <div className="dialog" onClick={ ( e ) => e.stopPropagation() }>
                ...
                <tr key={ inst.id }>
                  ...
                  <td>
                    <input
                      ...
                      value={ inst.soundId ?? "" }
                      onChange={ ( e ) => updateInstrument( index, { soundId: e.target.value || undefined } ) }
                    />
                  </td>
                  <td>
                    <input
                      ...
                      onChange={ ( e ) => updateInstrument( index, { baseBlock: e.target.value || undefined } ) }
                    />
                  </td>
                  <td className="inst-actions">
                    ...
                    <button onClick={ () => removeInstrument( index ) } title="Remove (notes fall back to harp)">
                      ×
                    </button>
                  </td>
                </tr>
        ...
        <details className="inst-midi">
          <summary title="Only affects the .mid export; stored in the project file">MIDI export — GM programs</summary>
          <table className="inst-table">
            <tbody>
